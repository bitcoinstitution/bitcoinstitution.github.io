...
1. Government money (and debt) across the world is increasing exponentially. And it's unstoppable, making us all stand on a ticking time bomb — only a few years away from detonation.
2. Only 5% of the bitcoin supply is left to mine. Many people/corporations/countries that hold the circulating 95% understand bitcoin — making them reluctant to sell.
3. At this point, it's impossible for other similar cryptocurrency projects with anonymous founders to beat bitcoin's popularity. A project with a well-identified founder might appear simply as the next-generation global central bank.
...
Don't worry. This race isn’t about winning gold, silver, or bronze. In this race, every country (or local economy) that runs as fast as it can, wins.

And you — the bones and muscles your local economy needs to run in this race — are responsible for that.

> Because with great knowledge comes great responsibility.

Bitcoinstitution exists to help you fulfill that responsibility efficiently and effectively.

Of course, only if you care about your local economy's future.

# What Is 'Bitcoinstitution' Anyway?

Bitcoinstitution is simply a bitcoin educational institute.

We have a growing number of professional bitcoin educators who allocate at least 4 hours per month to teach bitcoin.
...
This is especially true when educating the private sector and the government — the two backbones of every local economy. These audiences prefer B2B engagement and expect professionalism, consistency, and accountability.

In each educational program we run, all educators collectively monitor and supervise its full execution to ensure quality and integrity.

Sounds interesting? Join us.

# Who is Behind Bitcoinstitution?

We are bitcoiners with three different strengths.
...
There’s no remote version, because it’s full of student-centered activities. Learning about bitcoin and the reason for its creation requires a lot of unlearning. Based on our experience, a face-to-face format helps a lot with that.
...
We end with practical, math-based guidance on bitcoin accumulation, to truly set students free by the year 2035. Yes, it includes the demo of buying, selling, storing bitcoin. 

That’s it. The goal is to lay the path to real financial sovereignty in just two hours. We aim to create the most effective and scalable way to pull people out of the real-life matrix.
...
1. If you love teaching, please consider to become a [Financial Sovereignty](/) trainer: Attend one of the trainings; Study hard for the [₿-CERT](https://planb.academy/en/certifications/b-cert) qualification; Tell us the place and schedule for your session. We’ll handle the rest.
2. If you prefer not to teach, please help spread awareness of our programs. Refer your bitcoin-skeptic friends and family to the nearest Financial Sovereignty training.
